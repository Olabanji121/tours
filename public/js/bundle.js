...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\" style= \"margin-top: 12rem\">").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.msg);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error Logging Out Try Aagin!!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            msg = _context.t0.response.data.message.split(' ');
            (0, _alert.showAlert)('error', msg.slice(4, 15).join(' '));
...
exports.dsiplayMap = void 0;

var dsiplayMap = function dsiplayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2JhbmoxMjEiLCJhIjoiY2s0dHNhMW9zMDA5MzNlbnR4ZHJzenl0NSJ9.uy1VAQ5ro4lJCqNZazXz_A';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, slug, duration, maxGroupSize, difficulty, price, tourID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function UpdateTour(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateTourBtn = document.querySelector('.form-tour');
var bookBtn = document.getElementById('book-tour');

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // console.log(locations);

  (0, _mapbox.dsiplayMap)(locations);
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; // to clear input fields
...
if (updateTourBtn) {
  updateTourBtn.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name').value;
    ...
    var tourID = document.getElementById('id').value; //     UpdateSettings({name,email}, 'data')

    (0, _updateTour.UpdateTour)({
      name: name,
      slug: slug,
      duration: duration,
      maxGroupSize: maxGroupSize,
...
},{"./login":"login.js","./signup":"signup.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./updateTour":"updateTour.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
