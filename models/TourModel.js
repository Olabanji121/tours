...
const TourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        msg: 'Discount price({VALUE}) should be below  actual price'
      }
    },
...
// Document pre-Middleware it runs b4 .save() and .create()
...
// Document post- Middleware it runs after .save() and .create()
...
TourSchema.pre(/^find/, function(next){
  this.populate({
    path:'guides',
    select: '-__v -passwordchangedat -datecreated '
  });
  next()
})

// Query  post -Middleware .save() and .create()
